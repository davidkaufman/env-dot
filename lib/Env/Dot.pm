...
and you specify B<DOTENV_FILEPATHS=project-root/sub-project/.env:project-root/.env>,
...
N.B. The ordering has changed in version 0.0.8.
...
The executable is distributed together with Env::Dot package in directory I<script>.
